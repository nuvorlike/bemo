(() => {
        ...
        if (
          ...
          if ("auto" === s.slidesPerView) {
            ...
            if (
              ...
              P = e.isHorizontal() ? C(r, "width", !0) : C(r, "height", !0);
            else {
              const e = t(n, "width"),
                s = t(n, "padding-left"),
                i = t(n, "padding-right"),
            ...
            (P = (n - (s.slidesPerView - 1) * b) / s.slidesPerView),
              s.roundLengths && (P = Math.floor(P)),
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < i.length; e += 1) {
        ...
        f && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e)),
          G(l, f, s.slideVisibleClass),
          G(l, m, s.slideFullyVisibleClass),
          (l.progress = r ? -c : c),
  ...
  var q = {
    slideTo: function (e, t, s, i, r) {
      ...
      if (!(S && r) && ((u && -v === n.translate) || (!u && v === n.translate)))
        return (
  ...
  var R = {
    loopCreate: function (e) {
      ...
      const r = () => {
        ...
        d = (e) => {
          for (let i = 0; i < e; i += 1) {
            const e = t.isElement
              ? E("swiper-slide", [s.slideBlankClass])
              : E("div", [s.slideClass, s.slideBlankClass]);
            t.slidesEl.append(e);
          }
        };
      if (o) {
    ...
    loopFix: function (e) {
      ...
      let M = 0,
        C = 0;
      const L = w ? Math.ceil(d.length / h.grid.rows) : d.length,
  ...
  function H(e) {
    ...
    if ("touchstart" === i.type) return void j(t, i, i.targetTouches[0].pageX);
  ...
  function Y(e) {
    ...
    if (!i.isMoved) {
      if (
        (S && b && s.loopFix({ direction: s.swipeDirection }),
  ...
  function X(e) {
    ...
    for (
      ...
      void 0 !== l[e + t]
        ? (h || (u >= l[e] && u < l[e + t])) && ((g = e), (v = l[e + t] - l[e]))
        : (h || u >= l[e]) &&
    ...
    n.rewind &&
      (t.isBeginning
        ...
        : t.isEnd && (w = 0));
    const b = (u - l[g]) / v,
      T = g < n.slidesPerGroupSkip - 1 ? 1 : n.slidesPerGroup;
    if (p > n.longSwipesMs) {
      if (!n.longSwipes) return void t.slideTo(t.activeIndex);
      "next" === t.swipeDirection &&
        (b >= n.longSwipesRatio
          ? t.slideTo(n.rewind && t.isEnd ? w : g + T)
          : t.slideTo(g)),
        "prev" === t.swipeDirection &&
          (b > 1 - n.longSwipesRatio
            ? t.slideTo(g + T)
            : null !== S && b < 0 && Math.abs(b) > n.longSwipesRatio
            ? t.slideTo(S)
            : t.slideTo(g));
    } else {
      ...
      (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
        ? r.target === t.navigation.nextEl
          ? t.slideTo(g + T)
          : t.slideTo(g)
        : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : g + T),
          "prev" === t.swipeDirection && t.slideTo(null !== S ? S : g));
    }
  }
  function U() {
    const e = this,
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = o.direction && o.direction !== i.direction,
            ...
            f = i.loop;
          h && s && e.changeDirection(), w(e.params, o);
  ...
  const ce = document.querySelectorAll(".pl-func"),
    pe = document.querySelectorAll(".pr-func");
  let ue;
  function he() {
    (ue = window.innerWidth < 1630 ? 15 : (window.innerWidth - 1600) / 2),
      ce.length &&
        ce.forEach((e) => {
          e.style.paddingLeft = ue + "px";
        }),
      pe.length &&
        pe.forEach((e) => {
          e.style.paddingRight = ue + "px";
        });
  }
  he(),
    (document.body.onresize = he),
    window.innerWidth > 767.98 &&
      window.addEventListener("scroll", () => {
        const e = document.querySelector(".join"),
          t = document.getElementById("joinImg1"),
          s = document.getElementById("joinImg2"),
          i = document.getElementById("joinImg3"),
          r = document.querySelector(".main-join__title");
        (s.style.transform = "translateY(-8%)"),
          (s.style.transform = "translateY(-16%)"),
          (i.style.transform = "translateY(-32%)"),
          (r.style.transform = "translateY(60%)");
        const n = e.offsetHeight,
          a = e.getBoundingClientRect().top,
          o = window.innerHeight;
        if (a < o) {
          let e = Math.min(100, ((o - a) / n) * 100);
          const l = (50 - e) / 50;
          if (((r.style.transform = `translateY(${60 * l}%)`), e > 50)) {
            const n = (100 - e) / 50;
            (t.style.transform = `translateY(${-8 * n}%)`),
              (s.style.transform = `translateY(${-16 * n}%)`),
              (i.style.transform = `translateY(${-32 * n}%)`),
              (r.style.transform = "translateY(0%)");
          }
        }
      });
  const me = document.querySelector(".swap__slider-image");
  async function fe() {
    try {
      const e = document.querySelector(".how__ca"),
        t = document.getElementById("tokenValue").textContent.trim();
      e.classList.contains("ca-copied") ||
        (e.classList.add("ca-copied"),
        setTimeout(() => {
          e.classList.remove("ca-copied");
        }, 2600)),
  ...
  document.querySelector(".join__decor").style.left = `${(function (e) {
  ...
  document.querySelectorAll(".copy-ca-btn").forEach((e) => {
    e.onclick = fe;
  });
  const ve = document.querySelector(".page__bubbles");
  function we() {
    const e = document.createElement("img");
    e.setAttribute("src", "img/bubble.png"), e.setAttribute("alt", "Bubble");
    const t = document.createElement("span");
    t.classList.add("bubble"),
      (t.style.width = `${ge(20, 60)}px`),
      (t.style.left = `${ge(0, 100)}%`),
      t.append(e),
      ve.append(t),
      setTimeout(() => {
        t.remove();
        ...
        if ("click" === t.type) {
          ...
          if (s.closest("[data-goto]")) {
            const i = s.closest("[data-goto]"),
              ...
              l = i.dataset.gotoTop ? parseInt(i.dataset.gotoTop) : 0;
            if (e.fullpage) {
              const t = document
                  .querySelector(`${r}`)
